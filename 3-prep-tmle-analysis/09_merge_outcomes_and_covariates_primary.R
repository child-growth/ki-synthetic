...
# cov$safeh20 <- relevel(factor(cov$safeh20), ref="1")
# cov$predfeed3 <- relevel(factor(cov$predfeed3), ref="1")
# cov$exclfeed3 <- relevel(factor(cov$exclfeed3), ref="1")
# cov$predfeed6 <- relevel(factor(cov$predfeed6), ref="1")
# cov$exclfeed6 <- relevel(factor(cov$exclfeed6), ref="1")
# cov$predfeed36 <- relevel(factor(cov$predfeed36), ref="1")
# cov$exclfeed36 <- relevel(factor(cov$exclfeed36), ref="1")
cov$predexfd6 <- relevel(factor(cov$predexfd6), ref="1")



cov$perdiar6 <- relevel(factor(cov$perdiar6), ref="0%")
cov$perdiar24 <- relevel(factor(cov$perdiar24), ref="0%")
