...
load(file="/data/KI/synthetic-data/wast_cuminc.rdata")
cuminc_sev <- cuminc %>% filter(agecat=="0-24 months")
load(file="/data/KI/synthetic-data/wast_cuminc_nobirth.rdata")
cuminc_nobirth_sev <- cuminc_nobirth %>% filter(agecat=="0-24 months (no birth wast)")
load(file="/data/KI/synthetic-data/pers_wast.rdata")
pers_wast <- pers_wast %>% filter(agecat=="0-24 months")

save(cuminc, file="/data/KI/synthetic-data/wast_cuminc_primary.rdata")
save(cuminc_nobirth, file="/data/KI/synthetic-data/wast_cuminc_nobirth_primary.rdata")
save(cuminc_sev, file="/data/KI/synthetic-data/swast_cuminc_primary.rdata")
save(cuminc_nobirth_sev, file="/data/KI/synthetic-data/swast_cuminc_nobirth_primary.rdata")
save(pers_wast, file="/data/KI/synthetic-data/pers_wast_primary.rdata")

load(file="/data/KI/synthetic-data/st_cuminc_outcomes.rdata")
cuminc_sev <- cuminc %>% filter(agecat=="0-24 months")
load(file="/data/KI/synthetic-data/st_cuminc_outcomes_nobirth.rdata")
cuminc_nobirth_sev <- cuminc_nobirth %>% filter(agecat=="0-24 months (no birth st.)")

save(cuminc, file="/data/KI/synthetic-data/st_cuminc_outcomes_primary.rdata")
save(cuminc_nobirth, file="/data/KI/synthetic-data/st_cuminc_outcomes_nobirth_primary.rdata")
save(cuminc_sev, file="/data/KI/synthetic-data/sst_cuminc_outcomes_primary.rdata")
save(cuminc_nobirth_sev, file="/data/KI/synthetic-data/sst_cuminc_outcomes_nobirth_primary.rdata")
