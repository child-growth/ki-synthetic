...
Anthropometry estimates match exactly between the real data and the QI/BC datasets, but while mean Z-scores from the fully synthetic data mostly match, the prevalences and incidences of wasting and stunting are lower.
